...
public class ChangeReasons {
	...
	public static final Identifier TNT = register(new Identifier("whodoneit:tnt"), PreventionCategories.PLAYER);
	...
	public static void forEach(Consumer<Pair<Identifier, Identifier>> idConsumer) {
		REASONS.forEach(idConsumer);
	}
	
	public static Identifier register(Identifier name, Identifier category) {
